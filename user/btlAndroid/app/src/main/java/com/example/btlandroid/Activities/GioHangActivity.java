...
import com.example.btlandroid.Adapter.GioHangAdapter;
import com.example.btlandroid.Model.EventBus.TinhTongEvent;
        ...
        btnMuaHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Utils.mangmuahang.size() == 0){
                    Toast.makeText(GioHangActivity.this, "Vui lòng chọn sản phẩm", Toast.LENGTH_SHORT).show();
                } else {
