            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img class="img-card-person" src="img/<?php echo $row["anhthe"] ?>" alt=""></td>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <input class="form-control" type="text" required value="Nguyễn Văn Linh">
            </div>
            <div class="form-group  col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input class="form-control" type="text" required value="linh@gmail.com">
            </div>
            <div class="form-group col-md-6">
